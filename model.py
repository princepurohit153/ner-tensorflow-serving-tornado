...
class SequenceLabelingModel(object):
    ...
    def __init__(self, sequence_length, nb_classes, nb_hidden=512, num_layers=1,
        ...
        self._get_rnn_unit = self.get_rnn_unit
    ...
    def get_rnn_unit(self, rnn_unit):
        if rnn_unit == 'lstm':
    ...
    def fit(self, data_dict, dev_size=0.15, seed=1337):
        """
        训练
        Args:
    ...
    def predict(self, data_test_dict):
        ...
        for i in tqdm(range(nb_test)):
            ...
            #print 'logits', logits,'\n sequence_actual_length',sequence_actual_length,'\n transition_params',transition_params
